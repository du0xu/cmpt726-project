"""
Generate images (body + background) as the input of our model, using captured images and segmentation data.
...
2) Run this script. Generated images will be saved to `./data/generated/`.
"""
import json
import os
import random
...
if __name__ == '__main__':
    ...
    for i in range(len(img_json_files)):
        ...
        for j in range(len(img_info)):
            ...
            masked_img_cropped = masked_img[crop_y_min:crop_y_max, crop_x_min:crop_x_max]
            mask_inv_cropped = mask_inv[crop_y_min:crop_y_max, crop_x_min:crop_x_max]
